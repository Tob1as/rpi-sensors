...
<html>
	<head>
		...
		<script src='https://cdn.jsdelivr.net/npm/highcharts@8.2.2/highstock.js'></script>
		<script src='https://cdn.jsdelivr.net/npm/highcharts@8.2.2/modules/exporting.js'></script>
	</head>
	<body>
		<h1>Sensors:</h1>
		<p>
